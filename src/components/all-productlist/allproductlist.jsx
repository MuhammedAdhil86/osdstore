...
export default function AllProductsList() {
  ...
  return (
    <div className="p-4 mt-16 md:p-8 max-w-6xl mx-auto  md:mt-32 lg:mt-32">
      <h1 className="text-2xl  md:text-3xl font-bold mb-4">ALL PRODUCTS</h1>
      ...
      <div className="flex flex-col md:flex-row justify-between items-center text-sm text-gray-600 mb-6 gap-4">
        ...
        <div className="flex justify-end  md:mt-16 md:hidden mr-64">
          <button
      ...
      <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 gap-6">
        {filteredProducts.map((product, index) => (
          <motion.div
            ...
            initial="hidden"
            animate="visible"
            className="border p-4 rounded-lg shadow-lg w-full h-full max-w-xs mx-auto"
          >
            <img
              src={product.image}
              alt={product.name}
              className="lg:w-full lg:h-48 object-cover mb-4"
            />
            <h2 className="text-lg md:text-xl font-semibold text-center w-34 h-12">
              {product.name}
            </h2>
            <p className="text-md md:text-lg font-bold mt-2 text-center">
              Rs. {product.price}
            </p>
            <button className="flex items-center mt-3 py-2 sm:px-4 bg-black text-white rounded-md hover:bg-gray-800 w-full justify-center">
